...
function App() {
  ...
  return (
    <div className="app">
      ...
      <footer>
        <a href="https://github.com/jlast/pokedoku-solver/issues" target="_blank" rel="noopener noreferrer">
        ...
        <span>•</span>
        <a href="https://www.reddit.com/user/pokedoku-solver/" target="_blank" rel="noopener noreferrer">
